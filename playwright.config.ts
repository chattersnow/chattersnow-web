...
const MUTATING_SPECS =
  /(page-visibility|unresolved-host|tenant-branding|legal-publication|module-gating|programs-source|person-role-labels|team-layout|team-source|site-photo-crop)\.spec\.ts/;
