...
**Out of scope for phase 1**, and each a candidate for its own ticket: payment-processor integration, refunds and partial voids, printed or emailed receipts, a stock movement log (receiving, shrinkage, counts — today `stock_on_hand` moves only through sales and voids), and demo-tenant seed data for the module.
