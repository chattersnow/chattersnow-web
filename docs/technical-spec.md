...
Data model and portal CRUD implemented (issues #103, #104); public surface, content-opportunity workflow, and program intelligence remain planned — see §5.20 and issue #102.
