...
Data model, portal CRUD, the public surface, the content-opportunity workflow, brief templates, work queues, editorial guardrails, audit history, configurable program suggestions, related-item recommendations, and the annual planning review report are all implemented (issues #103, #104, #105, #106, #107, #108, #109, #110, #111, #112, #113); optional iCal export remains planned as a follow-up to #111 — see §5.20 and issue #102.
