 ...
 *
 * The write, the decision to confirm and the confirmation's arguments all live
 * in setMyNotificationEmail (#1125), which the person-record path shares; this
 * adds the two things only Next can supply -- a scheduler for the deferred
 * send, and the revalidation.
 */
