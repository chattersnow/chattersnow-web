...
/**
 * Organizations became a segment of the People directory in #957.
 *
 ...
 */
export default async function OrganizationsMovedPage({
  searchParams,
}: {
  ...
  redirect(`/portal/people/organizations${query ? `?${query}` : ""}`);
}
