...
const VOTE_OUTCOMES: readonly VoteOutcome[] = ["pending", "passed", "failed", "tabled"];
...
export function parseResolutionForm(formData: FormData): ParseResult<ResolutionFormData> {
