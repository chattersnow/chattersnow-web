...
export function NewSuggestionRuleDialog({
  ...
  return (
    <PortalFormSurface
      ...
      title="Create program suggestion rule"
      description="When a calendar item matches this item type and/or category, the program appears as an editable suggestion in the item editor — it is never added automatically."
