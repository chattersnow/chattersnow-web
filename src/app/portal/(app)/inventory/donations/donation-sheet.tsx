...
export function DonationSheet({ donation }: { donation: DonationRow }) {
                  ...
                  {donation.inventory_items.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Field>
                          <FieldLabel
                            htmlFor={`edit-item-faceValue-${item.id}`}
                          >
                            Face value ($)
                          </FieldLabel>
                          <Input
