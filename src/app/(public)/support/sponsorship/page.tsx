          ...
          <Card>
            ...
            <CardContent>
              <p className="app-muted text-sm leading-relaxed">
                ...
                like our gear library. Cash sponsors are the easiest way to keep
                events affordable and accessible.
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <p className="app-muted text-sm leading-relaxed">
                ...
                support stretches directly into gear drives, event day
          ...
          <Card>
            ...
            <CardContent>
              <p className="app-muted text-sm leading-relaxed">
                ...
                season. We&apos;ll work with you to find a combination that fits
                your organization.
              </p>
            </CardContent>
          </Card>
