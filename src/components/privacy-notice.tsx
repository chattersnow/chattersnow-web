...
export type PrivacyNoticeSurface =
  "eventRegistration" | "volunteerApplication" | "gearRequest" | "contact";
 ...
 * carry no choice -- and it would sit beside boxes that do (photo consent
 * #599, the participant waiver #686), diluting them. Reserve the ticking for
 * what can genuinely be declined.
 *
